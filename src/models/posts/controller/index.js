...
import { CreatePostDTO, CreateCommentDTO, CreateChildCommentDTO, UpdatePostDTO } from "../dto";
...
class PostController {
  ...
  // /posts?page=1&limit=1&searchValue=test
  ...
  async updateComment(req, res, next) {
    try {
      ...
      await this.postService.updateComment(commentId, new UpdatePostDTO(body), req.user)
